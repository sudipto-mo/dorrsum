...
export type Persona = "providers" | "sponsors";
...
export default function AdvisoryPersonaTabs({
  ...
  const active: Persona =
    (searchParams.get("persona") as Persona) ?? initialPersona;
  const c = CONTENT[active];

  return (
    <div className="mt-12 max-w-6xl">
      {/* Active panel */}
      <div className="mt-4 rounded-2xl border border-slate-800/80 bg-slate-900/30 p-8 shadow-[0_18px_60px_rgba(0,0,0,0.45)] backdrop-blur-md">
